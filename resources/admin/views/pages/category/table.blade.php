<div class="table">
                    ...
                    <div class="w-full flex gap-3">
                        <div class="flex-auto border-t-[1px] border-b-[1px] border-gray-200 bg-gray-50">
                            <div class="flex h-11">
                                ...
                                <div class="w-35/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>Slug</span>
                                </div>
                    ...
                    <div class="w-full flex gap-3 h-[70px]">
                        <div class="flex-auto border-b-[1px] border-gray-200">
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-25/100 text-gray-500 flex items-center">
                                    <span class="text-sm" x-text="item?.parent?.title?.en ?? '-'"></span>
                                </div>
                                <div class="w-35/100 text-gray-500 flex items-center">
                                    <span class="text-sm" x-text="item?.slug ?? '-'"></span>
                                </div>
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['category-update', 'category-update-status', 'category-delete',
                                            'category-restore'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('category-update')
                                                <li x-show="!item.deleted_at">
                                                    <a class="dropdown-item" @click="openStoreCategoryDialog(item?.id)">
                                                        <span
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.category')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.category')]),
        ])
        @endcomponent
    </template>
</div>
