...
@endsection
@section('layout')
    <div class="form-admin" x-data="privacyPolicyPage">
        @include('admin::shared.header', [
            'title' => __('form.name.privacy_policy'),
            'header_name' => __('form.name.privacy_policy'),
        ])
...
@section('script')
    ...
    <script type="module">
        Alpine.data('privacyPolicyPage', () => ({
            form: new FormGroup({
                page: ['privacy_policy', ['required']],
                ...
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            ...
                            Axios({
                                url: `{{ route('admin-page-privacy-policy-save') }}`,
                                method: 'POST',
                                data: {
                                    ...data,
                                    id: this.id,
