<div class="table">
                    ...
                    <div class="w-full flex gap-3">
                        <div class="flex-auto border-t-[1px] border-b-[1px] border-gray-200 bg-gray-50">
                            <div class="flex h-11">
                                ...
                                <div class="w-50/100 text-sm font-bold text-gray-500 flex items-center">
                    ...
                    <div class="w-full flex gap-3 h-[76px]" x-data="{ status: item.status }">
                        <div class="flex-auto border-b-[1px] border-gray-200">
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-50/100 text-gray-500 flex items-center">
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{ open: false, toggle() { this.open = !this.open }, close() { this.open = false } }"
                                        ...
                                        @canany(['report-document-category-update', 'report-document-category-delete'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('report-document-category-update')
                                            ...
                                            @endcan
                                            @can('report-document-category-delete')
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.report_document_category')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.report_document_category')]),
        ])
        @endcomponent
    </template>
</div>
