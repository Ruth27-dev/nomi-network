<div class="table">
                        ...
                        <div class="flex-auto border-t-[1px] border-b-[1px] border-gray-200 bg-gray-50">
                            <div class="flex h-11">
                                ...
                                <div class="w-25/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('table.field.position')</span>
                                </div>
                                <div class="w-25/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('form.body.label.location')</span>
                                </div>
                                <div class="w-20/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('form.body.label.close_date')</span>
                                </div>
                                <div class="w-20/100 text-sm font-bold text-gray-500 flex items-center">
                        ...
                        <div class="flex-auto border-b-[1px] border-gray-200">
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-20/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center" x-text="formatDate(item.add_on?.close_date)"></span>
                                </div>
                                <div class="w-20/100 text-gray-500 flex items-center">
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['career-update', 'career-delete'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('career-update')
                                                <li x-show="!item.deleted_at">
                                                    <a class="dropdown-item" @click="openStoreCareerDialog(item)">
                                                        <span
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.career')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.career')]),
        ])
        @endcomponent
    </template>
</div>
