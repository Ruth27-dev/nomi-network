...
@endsection
@section('layout')
    <div class="form-admin" x-data="ourMissionPage">
        @include('admin::shared.header', [
            'title' => __('form.name.our_mission'),
            'header_name' => __('form.name.our_mission'),
        ])
...
@section('script')
    ...
    <script type="module">
        Alpine.data('ourMissionPage', () => ({
            form: new FormGroup({
                page: ['our_mission', ['required']],
                ...
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            ...
                            Axios({
                                url: `{{ route('admin-page-our-mission-save') }}`,
                                method: 'POST',
                                data: {
                                    ...data,
                                    id: this.id,
