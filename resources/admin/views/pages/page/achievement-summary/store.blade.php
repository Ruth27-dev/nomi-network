<template x-dialog="storeAchievementSummaryDialog">
        ...
        <form class="form-wrapper flex flex-col h-full">
            ...
            <div class="form-body flex-auto overflow-y-auto">
                ...
                <div class="form-row" x-show="locale == arrayLangLocale.en">
                    ...
                    <textarea id="as-desc-en" type="text" placeholder="@lang('form.body.placeholder.description_en')" x-model="form.description_en"
                ...
                <div class="form-row" x-show="locale == arrayLangLocale.km">
                    ...
                    <textarea id="as-desc-km" type="text" placeholder="@lang('form.body.placeholder.description_km')" x-model="form.description_km"
                        :disabled="form.disabled" autocomplete="off" rows="5"></textarea>
    ...
    <script>
        Alpine.data('storeAchievementSummaryDialog', () => ({
            ...
            async initTinymce() {
                tinymce.remove('#as-desc-en, #as-desc-km');
                await tinymce.init({
                    relative_urls: false,
                    selector: 'textarea#as-desc-en,textarea#as-desc-km',
                    height: 400,
                    plugins: [
            ...
            onSave() {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            this.form.description_en = tinymce.get('as-desc-en')?.getContent() ?? '';
                            this.form.description_km = tinymce.get('as-desc-km')?.getContent() ?? '';
                            this.form.disable();
                            this.loading = true;
