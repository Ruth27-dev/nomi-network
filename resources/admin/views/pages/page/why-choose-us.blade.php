...
@endsection
@section('layout')
    <div class="form-admin" x-data="WhyChooseUsPage">
        @include('admin::shared.header', [
            'title' => __('form.name.why_choose_us'),
            'header_name' => __('form.name.why_choose_us'),
        ])
...
@section('script')
    ...
    <script type="module">
        Alpine.data('WhyChooseUsPage', () => ({
            form: new FormGroup({
                page: ['why_choose_us', ['required']],
            ...
            onSave() {
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: async (result) => {
                        ...
                        Axios.post(`{{ route('admin-page-why-choose-us-save') }}`, formData, {
                            headers: {
