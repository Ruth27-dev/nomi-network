<div class="table">
                            ...
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-30/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center"
                                        x-text="item.title?.[langLocale] ?? item.title?.en ?? '-'"></span>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center" x-text="item.add_on?.price ?? '-'"></span>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['shipping-method-update', 'shipping-method-delete'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('shipping-method-update')
                                                <li x-show="!item.deleted_at">
                                                    <a class="dropdown-item" @click="openStoreShippingMethodDialog(item)">
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => 'Shipping Method']),
            'msg' => __('table.empty.message', ['name' => 'Shipping Method']),
        ])
        @endcomponent
    </template>
</div>
