<div class="table">
                        ...
                        <div class="flex-auto border-t-[1px] border-b-[1px] border-gray-200 bg-gray-50">
                            <div class="flex h-11">
                                ...
                                <div class="w-10/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span> @lang('table.field.qr_code')</span>
                                </div>
                                <div class="w-15/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('table.field.bank_name')</span>
                                </div>
                                <div class="w-15/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('table.field.account_name')</span>
                                </div>
                                <div class="w-15/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span>@lang('table.field.account_number')</span>
                                </div>
                                <div class="w-10/100 text-sm font-bold text-gray-500 flex items-center">
                                    <span> @lang('table.field.branch')</span>
                                </div>
                                <div class="w-15/100 text-sm font-bold text-gray-500 flex items-center">
                        ...
                        <div class="flex-auto border-b-[1px] border-gray-200">
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-10/100 text-gray-500 flex items-center">
                                    <div @click="onViewImage(item.qr_code_url)"
                                        class="cursor-pointer h-[50px] w-[50px]">
                                        <img x-bind:src="item.qr_code_url" class="h-full w-full rounded-[50px]"
                                            onerror="(this).src='{{ asset('images/logo.jpg') }}'" alt="" />
                                    </div>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center" x-text="item.bank_name"></span>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                    <span class="text-sm"
                                        x-text="item.bank_number ?? '-'"></span>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center" x-text="item.account_name ?? '-'"></span>
                                </div>
                                   <div class="w-10/100 text-gray-500 flex items-center">
                                    <span class="text-sm text-center" x-text="getItemByLang(JSON.stringify(item?.branch?.title), langLocale, arrayLangLocale) ?? '-'"></span>
                                </div>
                                <div class="w-15/100 text-gray-500 flex items-center">
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['bank-account-update', 'bank-account-delete'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('bank-account-update')
                                                <li x-show="!item.deleted_at">
                                                    <a class="dropdown-item" @click="openStoreBankAccountDialog(item)">
                                                        <span
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.bank_account')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.bank_account')]),
        ])
        @endcomponent
    </template>
</div>
