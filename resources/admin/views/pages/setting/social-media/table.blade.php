<div class="table">
                            ...
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['social-media-update', 'social-media-delete'])
                                        ...
                                        <ul x-ref="panel" x-show="open" x-transition.origin.top.right
                                            ...
                                            @can('social-media-update')
                                                <li x-show="!item.deleted_at">
                                                    <a class="dropdown-item" @click="openStoreSocialMediaDialog(item)">
                                                        <span
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', [
            'name' => __('table.empty.title', ['name' => __('form.title.social_media')]),
            'msg' => __('table.empty.message', ['name' => __('form.title.social_media')]),
        ])
        @endcomponent
    </template>
</div>
