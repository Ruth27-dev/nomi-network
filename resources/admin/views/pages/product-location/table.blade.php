<div class="table">
                    ...
                    <div class="w-full flex gap-3 h-[70px]">
                        <div class="flex-auto border-b border-gray-200">
                            <div class="flex row-item h-full hover:bg-type_gray">
                                ...
                                <div class="w-30/100 text-gray-600 flex items-center">
                                    <span class="text-sm" x-text="item.name_en"></span>
                                </div>
                                <div class="w-20/100 text-gray-600 flex items-center">
                                    <span class="text-sm capitalize" x-text="item.location_type ?? '-'"></span>
                                </div>
                                <div class="w-30/100 text-gray-600 flex items-center pr-2">
                                    <span class="text-sm truncate" x-text="item.address ?? '-'"></span>
                                </div>
                                ...
                                <div class="w-5/100 text-gray-300 grid place-items-center">
                                    <div x-data="{
                                        ...
                                        @canany(['product-location-update', 'product-location-delete'])
    ...
    <template x-if="table && table?.empty()">
        @component('admin::components.empty', ['name' => 'No locations', 'msg' => 'No product locations found'])
        @endcomponent
    </template>
</div>
